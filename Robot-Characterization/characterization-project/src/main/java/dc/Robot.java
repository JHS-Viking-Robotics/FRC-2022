...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonSRX leftMotor = setupWPI_TalonSRX(3, Sides.LEFT, false);

    WPI_VictorSPX leftFollowerID53 = setupWPI_VictorSPX(53, Sides.FOLLOWER, false);
    leftFollowerID53.follow(leftMotor);

    WPI_TalonSRX rightMotor = setupWPI_TalonSRX(1, Sides.RIGHT, true);
    WPI_VictorSPX rightFollowerID51 = setupWPI_VictorSPX(51, Sides.FOLLOWER, true);    
    rightFollowerID51.follow(rightMotor);
